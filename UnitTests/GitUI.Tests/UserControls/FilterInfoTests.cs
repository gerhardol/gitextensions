...
namespace GitUITests.UserControls
{
    ...
    public class FilterInfoTests
    {
        ...
        [TestCase("author1", "committer2", "message3", "diffContent4", true, false, "pathFilter7", false, false, "branchFilter8",
            ...
            @"--max-count=100000 --not --glob=notes --not branchFilter8 --parents --no-merges --simplify-by-decoration --author=""author1"" --committer=""committer2"" --regexp-ignore-case --since=""2021-10-01 01:30:34"" --until=""2021-11-01 01:30:34"" -G""diffContent4"" --grep=""message3""")]
