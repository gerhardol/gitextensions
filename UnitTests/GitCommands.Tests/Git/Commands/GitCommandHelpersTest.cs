...
namespace GitCommandsTests.Git.Commands
{
    ...
    public class GitCommandsHelperTest
    {
        ...
        [TestCase(@"-c diff.submodule=short -c diff.noprefix=false -c diff.mnemonicprefix=false -c diff.ignoreSubmodules=none diff -M -C --cached extra -- ""new"" ""old""", "new", "old", true, "extra", false)]
        [TestCase(@"-c diff.submodule=short -c diff.noprefix=false -c diff.mnemonicprefix=false -c diff.ignoreSubmodules=none diff extra -- ""new""", "new", "old", false, "extra", false)]
        [TestCase(@"--no-optional-locks -c diff.submodule=short -c diff.noprefix=false -c diff.mnemonicprefix=false -c diff.ignoreSubmodules=none diff -M -C --cached extra -- ""new"" ""old""", "new", "old", true, "extra", true)]
