    ...
    internal sealed class AppSettingsTests
    {
        ...
        private static IEnumerable<object[]> TestCases()
        {
            ...
            static IEnumerable<(PropertyInfo property, object defaultValue, bool isNullable, bool isISetting)> PropertyInfos()
            {
                ...
                yield return (properties[nameof(AppSettings.DiffDisplayAppearance)], false, false, true);
                yield return (properties[nameof(AppSettings.RememberDiffDisplayAppearance)], false, false, true);
