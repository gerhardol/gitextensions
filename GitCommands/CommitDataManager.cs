...
namespace GitCommands
{
    public interface ICommitDataManager
    {
        ...
        /// </summary>
        void UpdateBody(CommitData commitData, bool bodyIsNull, out string? error);
    }
    ...
    public sealed class CommitDataManager : ICommitDataManager
    {
        ...
        /// <inheritdoc />
        public void UpdateBody(CommitData commitData, bool onlyNotes, out string? error)
        {
            if (!TryGetCommitLog(commitData.ObjectId.ToString(), onlyNotes ? NotesFormat : BodyAndNotesFormat, out error, out var data, cache: false))
            {
                return;
            }
