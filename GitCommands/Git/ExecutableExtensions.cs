...
namespace GitCommands
{
    ...
    public static class ExecutableExtensions
    {
            ...
            bool stripAnsiEscapeCodes = true)
        {
            ...
            if (cache is not null && cache.TryGet(arguments, out var cacheOutput, out var cacheError))
            {
                return new ExecutionResult(
                    CleanString(stripAnsiEscapeCodes, EncodingHelper.DecodeString(cacheOutput, null, ref outputEncoding)),
                    CleanString(stripAnsiEscapeCodes, EncodingHelper.DecodeString(null, cacheError, ref outputEncoding)),
                    0);
            }
