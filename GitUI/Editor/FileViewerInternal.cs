...
namespace GitUI.Editor
{
    public partial class FileViewerInternal : GitModuleControl, IFileViewer
    {
        ...
        private void TextArea_MouseWheel(object sender, MouseEventArgs e)
        {
            ...
            if (isScrollingTowardBottom && TextEditor.ActiveTextAreaControl.VScrollBar.Value + TextEditor.ActiveTextAreaControl.VScrollBar.Height >
        ...
        {
            return DateTime.Now - _lastScrollEventFiredDate < TimeSpan.FromMilliseconds(600);
        }
