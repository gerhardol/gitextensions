...
namespace GitUI
{
    internal sealed class TranslatedStrings : Translate
    {
        ...
        private readonly TranslationString _diffBaseToA = new("Diff BASE with a/");
        private readonly TranslationString _diffBaseToB = new("Diff BASE with b/");
...
- For more than four selected commits, show the difference from the first to the last selected commit.");
        ...
        private readonly TranslationString _clearFileFilterInGrid = new("Clear file filter in &grid");
        ...
        public static string ClearFileFilterInGrid => _instance.Value._clearFileFilterInGrid.Text;
