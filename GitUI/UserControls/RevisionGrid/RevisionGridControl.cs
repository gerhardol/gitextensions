...
namespace GitUI
{
    ...
    public sealed partial class RevisionGridControl : GitModuleControl, IScriptHostControl, ICheckRefs, IRunScript, IRevisionGridFilter
    {
        ...
        public void PerformRefreshRevisions(Func<RefsFilter, IReadOnlyList<IGitRef>> getRefs = null)
        {
            ...
            // Git will provide this information when available (so slower to first info if sorting).
            // This information from step 1. is therefore protected with Lazy accessors and a semaphore.
