                ...
                bool DrawItem(Graphics g, int index)
                {
                    ...
                    if (currentRow is not null)
                    {
                        ...
                        foreach (RevisionGraphSegment revisionGraphSegment in currentRow.Segments.Reverse().OrderBy(s => s.Child.IsRelative))
                        {
                            ...
                            if (!revisionGraphSegment.Parent.Children.IsEmpty
                                && !revisionGraphSegment.Parent.Children.Pop().IsEmpty)
                            {
                                // revisionGraphSegment.Parent.Children has more than one element
