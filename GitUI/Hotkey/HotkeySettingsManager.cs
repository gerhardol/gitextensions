        ...
        public static HotkeySettings[] CreateDefaultSettings()
        {
            ...
            return new[]
            {
                ...
                new HotkeySettings(
                    ...
                    Hk(FormBrowse.Command.FocusGitOutput, Keys.Control | Keys.D6),
                    Hk(FormBrowse.Command.FocusGitConsole, Keys.Control | Keys.D7),
                    Hk(FormBrowse.Command.FocusBuildServerStatus, Keys.Control | Keys.D8),
