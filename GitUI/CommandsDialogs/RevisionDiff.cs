...
namespace GitUI.CommandsDialogs
{
    public partial class RevisionDiff : GitModuleControl
    {
        ...
        private ContextMenuDiffToolInfo GetContextMenuDiffToolInfo()
        {
            ...
            bool bIsNormal = false; //B is assumed to be new or deleted (we cannot easily check A)
        ...
        private void openWithDifftoolToolStripMenuItem_DropDownOpening(object sender, EventArgs e)
        {
            ...
            parentOfALocalToolStripMenuItem.Visible = _revisionDiffController.ShouldShowMenuAParent(selectionInfo);
            parentOfBLocalToolStripMenuItem.Visible = _revisionDiffController.ShouldShowMenuBParent(selectionInfo);
        }
