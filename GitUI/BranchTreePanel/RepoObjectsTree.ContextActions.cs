...
namespace GitUI.BranchTreePanel
{
    partial class RepoObjectsTree : IMenuItemFactory
    {
        ...
        private void RegisterContextActions()
        {
            ...
            RegisterClick(mnubtnMoveUp, () => ReorderTreeNode(treeMain.SelectedNode.Tag as Tree, up: true));
            RegisterClick(mnubtnMoveDown, () => ReorderTreeNode(treeMain.SelectedNode.Tag as Tree, up: false));
