...
public static class ColorHelper
{
    ...
    /// Then ensure the contrast against the highlight background.
    ...
    /// the usual <see cref="SystemColors.GrayText"/>, ensuring contrast against the given background.
    /// Only used in Light mode.
    /// </summary>
    ...
    {
        double v = linear <= 0.0031308 ? 12.92 * linear : (1.055 * Math.Pow(linear, 1.0 / 2.4)) - 0.055;
