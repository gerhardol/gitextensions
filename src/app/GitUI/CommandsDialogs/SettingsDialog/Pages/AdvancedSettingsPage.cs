...
public partial class AdvancedSettingsPage : SettingsPageWithHeader
{
    ...
    protected override void SettingsToPage()
    {
        ...
        cboAutoNormaliseSymbol.SelectedValue = AppSettings.AutoNormaliseSymbol.Value;
    ...
    protected override void PageToSettings()
    {
        ...
        AppSettings.AutoNormaliseSymbol.Value = (string)cboAutoNormaliseSymbol.SelectedValue;
