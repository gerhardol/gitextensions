...
namespace GitExtensions.Plugins.GitHub3
{
    ...
    {
        private const int MaxMostRecenetIssuesDisplayed = 10;
        ...
        private List<string> _currentMessages = new(MaxMostRecenetIssuesDisplayed);
        ...
        private void GitUiCommands_PreCommit(object? sender, GitUIEventArgs e)
        {
            ...
            ThreadHelper.JoinableTaskFactory.RunAsync(async () =>
            {
                ...
                IEnumerable<Issue> recentUserIssues = issues.Where(i => i.Number != 0 && hostedRemotes.Any(r => r.Owner == i.Repository.Owner.Login && r.RemoteRepositoryName == i.Repository.Name))
                                                            .OrderByDescending(i => i.UpdatedAt)
                                                            .Take(MaxMostRecenetIssuesDisplayed);
