...
namespace GitUIPluginInterfaces.BuildServerIntegration
{
    ...
    {
        void Initialize(IBuildServerWatcher buildServerWatcher, ISettingsSource config, Func<string, bool> isCommitInRevisionGrid = null, string repoName = null, string branchName = null);
