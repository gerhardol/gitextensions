...
:bw
echo.
@echo hMSBuild - 2.0.0.61507 [ a40c6ac ]
...
set a8=!ap!
:cd
call :b2 "attempts with filter: " a8 a6 a4
set "a9=" & set "a_="
...
REM Workaround for VS2019, 
if !a_! geq 16.0 set a_=Current
