...
set GIT_VERSION=2.15.1
set KDIFF3_VERSION=0.9.97

md %~p0\cache\ 2> NUL

IF NOT EXIST "%~p0\cache\Git-%GIT_VERSION%-32-bit.exe" (
    "%~p0\tools\curl.exe" -L -k -o %~p0\cache\Git-%GIT_VERSION%-32-bit.exe https://github.com/git-for-windows/git/releases/download/v%GIT_VERSION%.windows.1/Git-%GIT_VERSION%-32-bit.exe
